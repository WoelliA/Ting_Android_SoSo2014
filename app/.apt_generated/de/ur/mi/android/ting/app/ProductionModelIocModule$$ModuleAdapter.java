 ...
 */
public final class ProductionModelIocModule$$ModuleAdapter extends ModuleAdapter<ProductionModelIocModule> {
  private static final String[] INJECTS = { };
  private static final Class<?>[] STATIC_INJECTIONS = { };
  private static final Class<?>[] INCLUDES = { };

  public ProductionModelIocModule$$ModuleAdapter() {
    super(de.ur.mi.android.ting.app.ProductionModelIocModule.class, INJECTS, STATIC_INJECTIONS, false /*overrides*/, INCLUDES, true /*complete*/, true /*library*/);
  }

  @Override
  public ProductionModelIocModule newModule() {
    return new de.ur.mi.android.ting.app.ProductionModelIocModule();
  }
  ...
  public static final class ProvideICategoryProviderProvidesAdapter extends ProvidesBinding<de.ur.mi.android.ting.model.ICategoryProvider>
    ...
    public ProvideICategoryProviderProvidesAdapter(ProductionModelIocModule module) {
      super("de.ur.mi.android.ting.model.ICategoryProvider", NOT_SINGLETON, "de.ur.mi.android.ting.app.ProductionModelIocModule", "provideICategoryProvider");
      this.module = module;
      setLibrary(true);
    }
